...
| `hideLogo` | <p>An boolean value determining whether the Spotify logo is shown when this module isn't playing music.</p><p>**Type:** `boolean` **OPTIONAL**<br>**Example:** `true`<br>**Default Value:** `false`</p> |
